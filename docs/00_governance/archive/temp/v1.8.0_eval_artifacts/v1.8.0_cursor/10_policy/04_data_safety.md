...
**원본 출처**: v1.7.1 §27-1,2,4,5 (3145–3200 + 3257–3342)
**v1.8.0 Layer**: Policy
**의존**: `00_core/01_primary.md`
**변경 이력**: 본 파일은 v1.7.1 §27-1,2,4,5 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cursor/10_policy/04_data_safety.md`
