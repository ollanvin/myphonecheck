# INDEX — MyPhoneCheck Architecture v2.5.0 (Claude Code)

**총 파일 수**: 78 (v2.4.0 동일, §1 검색 영역 4축 → 2축 단순화)
**총 크기**: 약 310 KB (§1 본문 정정 약 2KB 증가)
**원본**: v2.4.0 (§1 검색 4대 축 명문화 MINOR)
**WO**: WO-V250-CONST-2AXIS
**워커**: Claude Code
**작업 성격**: v2.4.0 → v2.5.0 MINOR 승격 — 검색 4축 → 2축 단순화. 대표님 2026-04-29 실측 결과: AI 검색 모드 1개가 (구) 공공 + 경쟁사 자체 통합 → 우리가 4축 분리 가중치 합산하는 것보다 정확. SIM 기준 AI 검색 후보군 자율 결정 명시. SearchInput sealed class 추가 (폰 번호 / URL / 메시지 본문 / 앱 패키지명).
**헌법**: 10개 조항 (§1 본문 정정만, 조항 신설 0)
**선행 보존**: v1.7.1 / v1.8.0 / v1.9.0 / v2.0.0 / v2.1.0 / v2.2.0 / v2.3.0 / v2.4.0 모두 FROZEN
