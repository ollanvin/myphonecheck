...
**변경 이력**: v1.9.0 cross-ref 및 Six Surfaces 범위 문구 갱신.
**파일 경로**: `docs/00_governance/architecture/v1.9.0/95_integration/02_infrastructure_reference.md`
...
| Six Surfaces 범위 | **Architecture** | 제품 기능 (v1.9.0 정식: CallCheck / MessageCheck / MicCheck / CameraCheck / PushCheck / CardCheck) |
