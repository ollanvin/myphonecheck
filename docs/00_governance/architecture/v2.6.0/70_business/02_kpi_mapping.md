...
**원본 출처**: v1.7.1 §0-B KPI (123–142)
**v1.8.0 Layer**: Business
**의존**: `00_core/01_primary.md`
**변경 이력**: 본 파일은 v1.7.1 §0-B KPI 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cursor/70_business/02_kpi_mapping.md`
...
|---|---|---|---|---|
| CONST-1 | Universal Truth Defense | §1-1 + §17 + §36 | 6 Surface 통합 테스트 PASS (v1.9.0 기준; v1.7.1 시점 4 Surface PASS 확장) | 대표님 |
