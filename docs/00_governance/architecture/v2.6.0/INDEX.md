# INDEX — MyPhoneCheck Architecture v2.6.0 (Claude Code)

**총 파일 수**: 78 (v2.5.0 동일, §3 본문 강화 + §11 신설 영역 정정)
**총 크기**: 약 314 KB
**원본**: v2.5.0 (검색 4축 → 2축 단순화 MINOR)
**WO**: WO-V260-CONST-3ACTIONS
**워커**: Claude Code
**작업 성격**: v2.5.0 → v2.6.0 MINOR — 사용자 소버린 철학 명문화. 우리 앱 액션 = 차단/태그/검색 디테일 3개로 한정. 수신/거절/자동 차단/기본 전화 앱 권한 = 영구 미포함. 시스템 dialer 미간섭. 경쟁 포지션 Hiya 진영 (전화 앱 대체 X, 차단·경고만).
**헌법**: 11개 조항 (§11 "3액션 단일 책임" 신설)
**선행 보존**: v1.7.1 / v1.8.0 / v1.9.0 / v2.0.0 / v2.1.0 / v2.2.0 / v2.3.0 / v2.4.0 / v2.5.0 모두 FROZEN
