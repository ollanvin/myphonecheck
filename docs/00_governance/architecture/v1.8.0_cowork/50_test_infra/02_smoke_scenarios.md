# 스모크런·드라이런·성공 기준 (테스트 관점)

**원본 출처**: v1.7.1 §18 + §19 + §20 (0줄)
**v1.8.0 Layer**: Test
**의존**: `20_features/25_smoke_scenarios.md` + `80_verification/01_dry_run_checklist.md`
**변경 이력**: 본 파일은 v1.7.1 §18 + §19 + §20 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/50_test_infra/02_smoke_scenarios.md`

---

<!-- §18 스모크런 전체는 20_features/25_smoke_scenarios.md 참조 -->
<!-- 본 파일은 §19 드라이런 + §20 성공 기준을 테스트 관점으로 이관 -->
