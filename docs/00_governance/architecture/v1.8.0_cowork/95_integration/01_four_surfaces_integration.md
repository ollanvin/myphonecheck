# Four Surfaces 통합 원칙 (Patch 22)

**원본 출처**: v1.7.1 §36 (149줄)
**v1.8.0 Layer**: Integration
**의존**: `06_product_design/05_product_strategy.md` + `05_constitution.md`
**변경 이력**: 본 파일은 v1.7.1 §36 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/95_integration/01_four_surfaces_integration.md`
