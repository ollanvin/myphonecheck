# Stage 0 Contracts + FREEZE 선언

**원본 출처**: v1.7.1 §33 Stage 0 + §23 FREEZE (218줄)
**v1.8.0 Layer**: Implementation
**의존**: `07_engine/03_nkb.md` + `05_constitution.md`
**변경 이력**: 본 파일은 v1.7.1 §33 Stage 0 + §23 FREEZE 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/60_implementation/02_stage0_freeze.md`
