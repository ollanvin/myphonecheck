# INDEX — MyPhoneCheck Architecture v2.0.0 (Claude Code)

**총 파일 수**: 76 (v1.9.0 73 + 28_initial_scan + 29_sim_oriented_core + 30_core_global_engine)
**총 크기**: 약 290 KB
**원본**: v1.9.0 (Six Surfaces 정식)
**WO**: WO-V200-MAJOR-001
**워커**: Claude Code
**작업 성격**: v1.9.0 → v2.0.0 MAJOR 승격 (One Core Engine + SIM-Oriented + Initial Scan, 헌법 7조 → 8조)
**헌법**: 8개 조항 (제8조 SIM-Oriented Single Core 신설)
**선행 보존**: v1.7.1 / v1.8.0 / v1.9.0 모두 FROZEN
...
│   └── 30_core_global_engine.md          ← §30 :core:global-engine (v2.0.0 신설, One Core Engine)
│
├── 40_i18n/
│   ├── README.md
