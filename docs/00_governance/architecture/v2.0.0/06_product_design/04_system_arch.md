...
**원본 출처**: v1.7.1 §5 (599–700)
**v1.9.0 Layer**: Core
**의존**: `00_core/01_primary.md`
**변경 이력**: v1.9.0 Six Surfaces 구조와 Surface 정의 정정 반영.
**파일 경로**: `docs/00_governance/architecture/v1.9.0/06_product_design/04_system_arch.md`
...
Decision Engine은 단 하나이며 **위협 평가 3 Surface(CallCheck·MessageCheck·PushCheck)**가 공유한다. MicCheck·CameraCheck는 PackageManager 직접 스캔, CardCheck는 SMS/Push 재활용 파서로 작동한다. Surface 분화는 허용되지만 엔진 분기는 금지 (§17 One Engine).
