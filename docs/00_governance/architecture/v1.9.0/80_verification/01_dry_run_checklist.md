...
**원본 출처**: v1.7.1 §19 (2464–2511)
**v1.8.0 Layer**: Verification
**의존**: `00_core/01_primary.md`
**변경 이력**: 본 파일은 v1.7.1 §19 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cursor/80_verification/01_dry_run_checklist.md`
...
- [ ] Six Surfaces 모두 FourAttributeCard 규격 준수 (CallCheck / MessageCheck / MicCheck / CameraCheck / PushCheck / CardCheck)
- [ ] 다크/라이트 모드 전환 확인
