...
**원본 출처**: v1.7.1 §4 (548–597)
**v1.9.0 Layer**: Core
**의존**: `00_core/01_primary.md`
**변경 이력**: v1.9.0 공통 UX 원칙 문구로 갱신.
**파일 경로**: `docs/00_governance/architecture/v1.9.0/06_product_design/03_ux_domains.md`
...
## 4-5. Six Surfaces 공통 UX 원칙

| 원칙 | 내용 |
|---|---|
| 일관성 | 6 Surface 모두 FourAttributeCard 규격 준수 |
