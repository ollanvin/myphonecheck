...
**의존**: `60_implementation/06_ci_cd.md` + `95_integration/01_four_surfaces_integration.md`
**변경 이력**: 본 파일은 v1.7.1 §35 (90줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/95_integration/02_infrastructure_reference.md`
