...
**의존**: `05_constitution.md` + `06_product_design/02_golden_egg.md`
**변경 이력**: 본 파일은 v1.7.1 §2 (42줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/06_product_design/01_goose_vs_egg.md`
