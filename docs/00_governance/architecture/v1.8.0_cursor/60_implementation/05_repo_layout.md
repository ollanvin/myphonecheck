...
**원본 출처**: v1.7.1 §23 (FREEZE 제외) (2613–2700 + 2713–2722)
**v1.8.0 Layer**: Implementation
**의존**: `00_core/01_primary.md`
**변경 이력**: 본 파일은 v1.7.1 §23 (FREEZE 제외) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cursor/60_implementation/05_repo_layout.md`
