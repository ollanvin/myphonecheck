...
**원본 출처**: v1.7.1 §8 (903–1215)
**v1.9.0 Layer**: Engine
**의존**: `00_core/01_primary.md`
**변경 이력**: v1.9.0 Six Surfaces 기준 DO_NOT_MISS 적용 범위 문구 갱신.
**파일 경로**: `docs/00_governance/architecture/v1.9.0/07_engine/03_nkb.md`
...
| Phase 3.5 | PushCheck (격리 알림·휴지통 복원 강조) |
| Phase 4.5 | CardCheck (고정 카드·고액 결제 강조) |
| Phase 후행 | AppSecurityWatch도 동일 규칙 적용 |
