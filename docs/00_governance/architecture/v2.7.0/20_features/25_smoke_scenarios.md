...
**원본 출처**: v1.7.1 §18 (스모크·보조 절) (분할 구간)
**v1.9.0 Layer**: Feature
**의존**: `00_core/01_primary.md`
**변경 이력**: v1.9.0 Six Surfaces 기준 용어 정정 반영.
**파일 경로**: `docs/00_governance/architecture/v1.9.0/20_features/25_smoke_scenarios.md`

---

# 18. 스모크런 시나리오 + Six Surfaces 본문

스모크런(Smoke Run)은 **구현 완료 즉시 수행**하는 제품 작동 검증. v1.5.2에서 11개 시나리오 정의, v1.6.0에서 Four Surfaces 관련 시나리오 확장, v1.9.0에서 Six Surfaces 기준으로 정렬한다.
