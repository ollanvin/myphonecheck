# INDEX — MyPhoneCheck Architecture v2.1.0 (Claude Code)

**총 파일 수**: 78 (v2.0.0 76 + 31_realtime_action + 32_tag_system)
**총 크기**: 약 300 KB
**원본**: v2.0.0 (One Core Engine + SIM-Oriented MAJOR)
**WO**: WO-V210-MINOR-001
**워커**: Claude Code
**작업 성격**: v2.0.0 → v2.1.0 MINOR 승격 (4-Layer 데이터 모델 + 검색 4축(Competitor 추가) + Real-time Action Engine + Tag System)
**헌법**: 8개 조항 (변경 없음 — MINOR)
**선행 보존**: v1.7.1 / v1.8.0 / v1.9.0 / v2.0.0 모두 FROZEN
