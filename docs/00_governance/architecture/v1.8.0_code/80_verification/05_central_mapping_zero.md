# 15. 본사 매핑 0건 검증 체크리스트 + 서버 코드 패턴 탐지

**원본 출처**: v1.7.1 §15 (20줄) + 서버 코드·문서 패턴 탐지 (47줄)
**v1.8.0 Layer**: Verification
**의존**: `05_constitution.md` (제1조 Out-Bound Zero)
**변경 이력**: 본 파일은 v1.7.1 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_code/80_verification/05_central_mapping_zero.md`
