# 18. 스모크런 시나리오 + Four Surfaces 본문 (CallCheck 관련)

**원본 출처**: v1.7.1 §18 중 §18-0 intro + §18-1~§18-3 (CallCheck 스모크런)
**v1.8.0 Layer**: Feature
**의존**: `06_product_design/04_system_arch.md` + `07_engine/05_decision_formula.md`
**변경 이력**: 본 파일은 v1.7.1 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_code/20_features/21_call.md`
