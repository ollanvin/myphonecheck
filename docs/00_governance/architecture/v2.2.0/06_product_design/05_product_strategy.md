...
## 17-3-B. v2.1.0 신규 정식 항목

| 항목 | 위치 | 정합 헌법 | 비고 |
|---|---|---|---|
| **4-Layer 데이터 모델** | §30-3-A | 1·2조 | OS / MyPhoneCheck / 외부 캐시 / 외부 검색 4계층 분리 |
| **검색 4축 (Competitor 추가)** | §30-4 정정 + §30-4-4 | 1조 옵트인 정합 | 더콜·후후·Whoscall 등 경쟁 앱 공개 데이터 활용 |
| **Real-time Action Engine** | §31 본문 | 1·2·3·4·5·8조 | CallScreening + SMS abortBroadcast + Push cancel, 50ms 응답 |
| **Tag System** | §32 본문 | 1·2·3·5조 | 휘발성 메모, REMIND_ME/PENDING/SUSPICIOUS/ARCHIVE priority |

v2.1.0 = MINOR (헌법 8조 변경 없음). 코드 구현은 후속 PR.
