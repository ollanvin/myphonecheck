# INDEX — MyPhoneCheck Architecture v2.2.0 (Claude Code)

**총 파일 수**: 78 (v2.1.0 동일, 헌법 본문 변경만)
**총 크기**: 약 305 KB (헌법 §9·§10 신설로 약 5KB 증가)
**원본**: v2.1.0 (4-Layer + Real-time + Tag + Competitor MINOR)
**WO**: WO-V220-MAJOR-001
**워커**: Claude Code
**작업 성격**: v2.1.0 → v2.2.0 MAJOR 승격 (헌법 §9 빅테크 정공법 + §10 비전 자율 결정 신설, 8조 → 10조)
**헌법**: 10개 조항 (제9조 빅테크 정공법 + 제10조 비전 자율 결정 신설)
**선행 보존**: v1.7.1 / v1.8.0 / v1.9.0 / v2.0.0 / v2.1.0 모두 FROZEN
...
├── INDEX.md                              ← 본 파일
├── README.md                             ← 폴더 목적 안내
├── 05_constitution.md                    ← §1 헌법 10조 (v2.0.0 §8조 + v2.2.0 §9 빅테크 정공법 + §10 비전 자율 결정 신설)
...
│   ├── 30_core_global_engine.md          ← §30 :core:global-engine (v2.0.0, v2.1.0 §30-3-A 4-Layer + 검색 4축 정정)
