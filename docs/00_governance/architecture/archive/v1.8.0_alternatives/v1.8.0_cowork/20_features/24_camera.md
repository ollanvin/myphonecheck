# CameraCheck (CAMERA 보유 앱 감시)

**원본 출처**: v1.7.1 §18-7 (0줄)
**v1.8.0 Layer**: Feature
**의존**: `07_engine/05_decision_formula.md` + `20_features/23_mic.md`
**변경 이력**: 본 파일은 v1.7.1 §18-7 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/20_features/24_camera.md`
