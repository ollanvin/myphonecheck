# Permissions + Manifest 정합

**원본 출처**: v1.7.1 §1 + §24-6 (0줄)
**v1.8.0 Layer**: Policy
**의존**: `05_constitution.md` + `00_core/01_primary.md`
**변경 이력**: 본 파일은 v1.7.1 §1 + §24-6 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/10_policy/01_permissions.md`

---

<!-- 비전 작성분 §1 — 00_core에서 참조. 본 파일은 §24-6 Manifest 전문 이관. -->
