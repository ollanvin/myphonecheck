...
**원본 출처**: v1.7.1 §2 + §18-4 (0줄)
**v1.8.0 Layer**: Policy
**의존**: `05_constitution.md` + `20_features/22_message.md`
**변경 이력**: 본 파일은 v1.7.1 §2 + §18-4 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/10_policy/02_sms_mode.md`

---

<!-- 비전 작성분 §2 — 00_core에서 참조. 본 파일은 §18-4 Mode A/B 상세 이관. -->
