# Open Issues (12건, v1.4_disc 계승 + v1.6.1 갱신)

**원본 출처**: v1.7.1 §21 (44줄)
**v1.8.0 Layer**: Verification
**의존**: `00_core/01_primary.md`
**변경 이력**: 본 파일은 v1.7.1 §21 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/80_verification/03_open_issues.md`
