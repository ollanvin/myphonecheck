# 드라이런 체크리스트 (Dry Run Checklist)

**원본 출처**: v1.7.1 §19 (52줄)
**v1.8.0 Layer**: Verification
**의존**: `20_features/25_smoke_scenarios.md`
**변경 이력**: 본 파일은 v1.7.1 §19 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/80_verification/01_dry_run_checklist.md`
