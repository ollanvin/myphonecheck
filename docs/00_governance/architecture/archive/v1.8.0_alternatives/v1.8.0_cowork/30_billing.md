# Billing 구현 세부 (Play Billing Library v7)

**원본 출처**: v1.7.1 §31 (249줄)
**v1.8.0 Layer**: Business
**의존**: `05_constitution.md` + `70_business/01_business_model.md`
**변경 이력**: 본 파일은 v1.7.1 §31 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/30_billing.md`
