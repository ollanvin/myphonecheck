# 3계층 소싱 상세 (Three-Layer Sourcing Detail)

**원본 출처**: v1.7.1 §6 (72줄)
**v1.8.0 Layer**: Engine
**의존**: `00_core/01_primary.md` + `05_constitution.md`
**변경 이력**: 본 파일은 v1.7.1 §6 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/07_engine/01_three_layer.md`
