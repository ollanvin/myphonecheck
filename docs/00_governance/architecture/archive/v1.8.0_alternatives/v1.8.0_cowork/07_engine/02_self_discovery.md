# Self-Discovery (환경 자가 발견)

**원본 출처**: v1.7.1 §7 (128줄)
**v1.8.0 Layer**: Engine
**의존**: `07_engine/01_three_layer.md`
**변경 이력**: 본 파일은 v1.7.1 §7 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/07_engine/02_self_discovery.md`
