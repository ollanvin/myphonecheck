# Interface Injection (v1.5.2 Patch 10)

**원본 출처**: v1.7.1 §32 (42줄)
**v1.8.0 Layer**: Implementation
**의존**: `07_engine/05_decision_formula.md`
**변경 이력**: 본 파일은 v1.7.1 §32 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_cowork/60_implementation/03_interface_injection.md`
