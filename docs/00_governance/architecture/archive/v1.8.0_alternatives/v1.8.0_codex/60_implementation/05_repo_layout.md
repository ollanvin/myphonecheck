...
**원본 출처**: v1.7.1 §23 + 기타 폴더 README 철칙 (101줄)
**v1.8.0 Layer**: Implementation
**의존**: `60_implementation/02_stage0_freeze.md` + `INDEX.md`
**변경 이력**: 본 파일은 v1.7.1 §23 + 기타 폴더 README 철칙 (101줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/60_implementation/05_repo_layout.md`
