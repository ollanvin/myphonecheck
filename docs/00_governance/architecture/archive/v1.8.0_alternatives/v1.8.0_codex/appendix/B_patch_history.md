...
**원본 출처**: v1.7.1 §0-B-1 + §0-B-2 (46줄)
**v1.8.0 Layer**: Appendix
**의존**: `appendix/A_audit_log.md` + `appendix/D_version_matrix.md`
**변경 이력**: 본 파일은 v1.7.1 §0-B-1 + §0-B-2 (46줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/appendix/B_patch_history.md`
