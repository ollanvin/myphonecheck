...
**의존**: `70_business/01_business_model.md` + `10_policy/03_special_access.md`
**변경 이력**: 본 파일은 v1.7.1 §31 (249줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/30_billing.md`
