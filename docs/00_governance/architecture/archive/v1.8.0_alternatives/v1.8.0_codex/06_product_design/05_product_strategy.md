...
**의존**: `20_features/21_call.md` + `95_integration/01_four_surfaces_integration.md`
**변경 이력**: 본 파일은 v1.7.1 §17 (63줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/06_product_design/05_product_strategy.md`
