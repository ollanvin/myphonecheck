...
**의존**: `50_test_infra/01_test_infra.md` + `80_verification/02_success_criteria.md`
**변경 이력**: 본 파일은 v1.7.1 §19 (52줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/80_verification/01_dry_run_checklist.md`
