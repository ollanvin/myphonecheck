...
**의존**: `30_billing.md` + `70_business/02_kpi_mapping.md`
**변경 이력**: 본 파일은 v1.7.1 §16 (65줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/70_business/01_business_model.md`
