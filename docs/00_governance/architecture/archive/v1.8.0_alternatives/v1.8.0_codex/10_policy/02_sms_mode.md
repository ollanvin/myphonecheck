...
**원본 출처**: v1.7.1 §18-4 (295줄)
**v1.8.0 Layer**: Policy
**의존**: `20_features/22_message.md` + `10_policy/05_permissions_declaration.md`
**변경 이력**: 본 파일은 v1.7.1 §18-4 (295줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/10_policy/02_sms_mode.md`
