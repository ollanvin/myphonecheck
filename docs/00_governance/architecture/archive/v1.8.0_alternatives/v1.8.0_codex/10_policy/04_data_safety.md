...
**원본 출처**: v1.7.1 §27-1, §27-2, §27-4, §27-5 (124줄)
**v1.8.0 Layer**: Policy
**의존**: `10_policy/05_permissions_declaration.md` + `50_test_infra/03_permission_matrix.md`
**변경 이력**: 본 파일은 v1.7.1 §27-1, §27-2, §27-4, §27-5 (124줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/10_policy/04_data_safety.md`
