...
**원본 출처**: v1.7.1 §28 (52줄)
**v1.8.0 Layer**: Policy
**의존**: `40_i18n/01_country_separation.md` + `10_policy/06_store_policy.md`
**변경 이력**: 본 파일은 v1.7.1 §28 (52줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/10_policy/07_country_i18n.md`
