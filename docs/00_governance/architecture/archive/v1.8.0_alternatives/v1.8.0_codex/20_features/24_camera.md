...
**원본 출처**: v1.7.1 §18-7 (73줄)
**v1.8.0 Layer**: Feature
**의존**: `10_policy/01_permissions.md` + `10_policy/03_special_access.md`
**변경 이력**: 본 파일은 v1.7.1 §18-7 (73줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/20_features/24_camera.md`
