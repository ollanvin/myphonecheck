...
**원본 출처**: v1.7.1 §14 (63줄)
**v1.8.0 Layer**: Engine
**의존**: `07_engine/06_cold_start.md` + `80_verification/02_success_criteria.md`
**변경 이력**: 본 파일은 v1.7.1 §14 (63줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/07_engine/08_sla.md`
