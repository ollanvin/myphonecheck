...
**원본 출처**: v1.7.1 §12 (50줄)
**v1.8.0 Layer**: Engine
**의존**: `07_engine/03_nkb.md` + `60_implementation/04_memory_budget.md`
**변경 이력**: 본 파일은 v1.7.1 §12 (50줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/07_engine/07_self_evolution.md`
