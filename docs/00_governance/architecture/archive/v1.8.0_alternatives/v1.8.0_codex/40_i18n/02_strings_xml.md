...
**원본 출처**: v1.7.1 §25 (91줄)
**v1.8.0 Layer**: i18n
**의존**: `06_product_design/03_ux_domains.md` + `10_policy/07_country_i18n.md`
**변경 이력**: 본 파일은 v1.7.1 §25 (91줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/40_i18n/02_strings_xml.md`
