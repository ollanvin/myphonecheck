...
**원본 출처**: v1.7.1 §34-1 (22줄)
**v1.8.0 Layer**: Test
**의존**: `10_policy/01_permissions.md` + `10_policy/05_permissions_declaration.md`
**변경 이력**: 본 파일은 v1.7.1 §34-1 (22줄) 원본 전문 이관본. 텍스트 변경 없음.
**파일 경로**: `docs/00_governance/architecture/v1.8.0_codex/50_test_infra/03_permission_matrix.md`
