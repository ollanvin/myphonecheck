...
object StorePackageSpec {
    ...
    const val APP_NAME = "CallCheck"
    const val PACKAGE_NAME = "app.callcheck.mobile"
    ...
    const val FULL_DESCRIPTION = """CallCheck provides real-time information about incoming calls to help you make informed decisions.
...
CallCheck — Know before you answer."""
    ...
    object DataSafety {
        ...
        const val PRIVACY_POLICY_SUMMARY = """CallCheck Privacy Policy Summary:
...
Contact: privacy@callcheck.app"""
        ...
        /** 개인정보 처리 방침 URL */
        const val PRIVACY_POLICY_URL = "https://callcheck.app/privacy"
        /** 이용약관 URL */
        const val TERMS_OF_SERVICE_URL = "https://callcheck.app/terms"
    }
