...
import app.myphonecheck.mobile.core.model.InterceptMetrics
import app.myphonecheck.mobile.core.model.InterceptPerformanceStats
...
class InterceptPerformanceTracker @Inject constructor() {
    ...
    fun getStatsReport(): String {
        ...
        return buildString {
            appendLine("═══ MyPhoneCheck 인터셉트 성능 ═══")
            appendLine()
