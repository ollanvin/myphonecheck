...
import app.myphonecheck.mobile.core.model.CaseFailure
import app.myphonecheck.mobile.core.model.CountryTestResult
import app.myphonecheck.mobile.core.model.CountryValidationSummary
...
class CountryCaseMatrix @Inject constructor(
    ...
    fun getValidationReport(): String {
        ...
        return buildString {
            appendLine("═══ MyPhoneCheck 국가 정책 검증 리포트 ═══")
            appendLine()
