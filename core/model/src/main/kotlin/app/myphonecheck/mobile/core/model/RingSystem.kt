...
import app.myphonecheck.mobile.core.model.R

/**
 * RingSystem — MyPhoneCheck 전체 제품의 단일 상태 소스 (Single Source of Truth).
 *
...
object RingSystem {
    ...
    const val DISCLAIMER_DETAIL_KO: String =
        ...
        "MyPhoneCheck는 판단 보조 도구이며, 통화 수신·거절·차단의 최종 결정은 사용자에게 있습니다."
    ...
    const val DISCLAIMER_DETAIL_EN: String =
        ...
        "MyPhoneCheck is a decision-support tool. The final decision to answer, reject, or block is yours."
